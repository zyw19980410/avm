...
def main():
    ...
    parser.add_argument("-i",'--input_folder', help="Must contain all modalities for each patient in the correct"
                                                     ...
                                                     "identifier (0000, 0001, etc)", default = '/media/zyw/本地磁盘/nnUNet-master/nnUNet_raw/nnUNet_raw_data/Task001_one/imagesTs'
                                                     )
    parser.add_argument('-o', "--output_folder", help="folder for saving predictions",default='/media/zyw/本地磁盘/nnUNet-master/avm/output')
    ...
    parser.add_argument('-f', '--folds', nargs='+', default=[5],
