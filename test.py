...
if __name__ == '__main__':
    ...
    base = '/media/zyw/本地磁盘/avm'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task001_one'
    ...
    # labels
    labels_dir_tr = join(base, 'seg')
    images_dir_tr = join(base, 'train')
    
    # finally we can call the utility for generating a dataset.json
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('s'),
                          labels={0: 'background', 1: '1',2:'2',3:'3',4:'4'}, dataset_name=task_name, license='hands off!')
